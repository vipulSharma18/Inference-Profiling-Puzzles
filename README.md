...
**Problem 1 - TorchAO Float8** [![Worklog](https://img.shields.io/badge/Worklog-76eec6)](./torchao_float8/README.md) [![Build](https://github.com/vipulSharma18/Inference-Profiling-and-Optimization-Guide/actions/workflows/build-torchao-float8.yml/badge.svg)](https://github.com/vipulSharma18/Inference-Profiling-and-Optimization-Guide/actions/workflows/build-torchao-float8.yml) **(In Progress)**: TorchAO's `Float8WeightOnlyConfig` is much slower than the eager baseline, and has much higher peak VRAM usage than eager. This was discovered during my work on a [survey of quantization formats](https://github.com/vipulSharma18/Survey-of-Quantization-Formats) (tested with 11/14/2025's nightly torchao-0.15.0dev on RTX4090 and RTX5090).      
